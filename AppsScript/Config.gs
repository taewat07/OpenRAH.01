...
var RAH01_HEADERS = Object.freeze({
  ...
  '04 Hazards': ['department_name', 'assessment_date', 'report_number', 'hazard_order', 'category_label_en', 'hazard_label_en', 'exposed_staff_count', 'exposed_client_count', 'exposure_score_a', 'severity_score_b', 'risk_score_c', 'risk_level', 'existing_controls', 'recommendation', 'has_attachment', 'category_code', 'hazard_key', 'custom_title', 'has_risk', 'assessment_id', 'hazard_evaluation_id'],

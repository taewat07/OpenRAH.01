...
- รองรับข้อมูลแผนกได้สูงสุด 150 แผนก โดย template เปิดใช้งาน 70 แผนกแรกและเตรียมแถวสำรองแบบ inactive อีก 80 แผนก
...
6. ตรวจรายการ 150 แผนกในแท็บ `Settings` โดย 70 แผนกแรกเป็น active ส่วนอีก 80 แถวเป็นแผนกสำรองแบบ inactive ก่อนเปิดใช้แถวสำรอง ให้เปลี่ยนชื่อแผนก แล้วตรวจรหัสและลำดับให้ไม่ซ้ำ
